...
| docker_storage_driver  | storage driver to use by the docker engine. Accepts two values. `overlay2` or `devicemapper`. If this variable is not defined, overlay2 is configured. |
